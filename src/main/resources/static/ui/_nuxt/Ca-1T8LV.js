import{D as M,Z as G,ah as P,a0 as l,ai as x,q as z,n as b,x as r,ao as q,cD as O,cE as L,cF as T,cG as _,y as X,a1 as A,a2 as j,a3 as I}from"./BEw8kgE9.js";import{f as S}from"./B-p6aW7q.js";let W=!1;function re(){if(M&&window.CSS&&!W&&(W=!0,"registerProperty"in(window==null?void 0:window.CSS)))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}function H(e){const{infoColor:c,successColor:g,warningColor:n,errorColor:t,textColor2:o,progressRailColor:f,fontSize:s,fontWeight:d}=e;return{fontSize:s,fontSizeCircle:"28px",fontWeightCircle:d,railColor:f,railHeight:"8px",iconSizeCircle:"36px",iconSizeLine:"18px",iconColor:c,iconColorInfo:c,iconColorSuccess:g,iconColorWarning:n,iconColorError:t,textColorCircle:o,textColorLineInner:"rgb(255, 255, 255)",textColorLineOuter:o,fillColor:c,fillColorInfo:c,fillColorSuccess:g,fillColorWarning:n,fillColorError:t,lineBgProcessing:"linear-gradient(90deg, rgba(255, 255, 255, .3) 0%, rgba(255, 255, 255, .5) 100%)"}}const Y={name:"Progress",common:G,self:H},E=P([l("progress",{display:"inline-block"},[l("progress-icon",`
