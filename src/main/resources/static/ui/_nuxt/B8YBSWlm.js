import{o as I,i as W}from"./jENkn2SK.js";import{t as A}from"./BRBXU5dJ.js";import{bO as C,Y as V,p as K,$ as H,br as N,ac as E,bs as G,af as _,q as Y,y as q,r as y,s as $,n as O,a0 as k,a1 as D,A as U,e as X,h as Z,g as J,ar as Q,bv as ee,x,V as oe,a2 as re,bZ as te}from"./BCga4dDV.js";function ne(o){const{borderRadius:l,avatarColor:a,cardColor:d,fontSize:c,heightTiny:u,heightSmall:s,heightMedium:z,heightLarge:h,heightHuge:i,modalColor:f,popoverColor:m}=o;return{borderRadius:l,fontSize:c,border:`2px solid ${d}`,heightTiny:u,heightSmall:s,heightMedium:z,heightLarge:h,heightHuge:i,color:C(d,a),colorModal:C(f,a),colorPopover:C(m,a)}}const ae={name:"Avatar",common:V,self:ne},se=K("n-avatar-group"),ie=H("avatar",`
